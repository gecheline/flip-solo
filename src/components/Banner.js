...
import ilikeyou_h from '../assets/ilikeyou_h_animation.png'
import ilikeyou_sq from '../assets/ilikeyou_sq_animation.png'
import ilikeyou_v from '../assets/ilikeyou_v_animation.png'
...
const Banner = () => (
    <Styles>
    <Parallax bgImage={ilikeyou_h} strength={300} className='customBg'>
