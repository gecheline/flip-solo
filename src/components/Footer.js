    ...
    <footer>
      ...
      <div className='footercontainer' id='contact'>
        <div className='row'>
          <div className = 'col'>
            <p><b>Contact</b></p>
            <span><a href="mailto:flipmusic@icloud.com" target="_blank" rel="noopener noreferrer" style={{color: '#d67770'}}>flipbandcontact@gmail.com</a></span>
          </div>
        ...
        <div className = 'col' id = 'newsletter'>
          ...
          <div className='col'>
            <p><b>EPK</b></p>
              <a href='https://www.sonicbids.com/band/flipbandofficial' target="_blank" rel="noopener noreferrer" style={{color: '#d67770'}}>https://www.sonicbids.com/band/flipbandofficial</a>
            </div>
          ...
          <div className='row'>
          <div className='col'>
          <p><em>Photography</em>: <span><a href="https://www.instagram.com/_sja_photography/" style={{color: '#d67770'}}>_sja_photography</a></span></p>
          </div>
          <div className='col'>
          <p><em>Web design</em>: <span><a href="https://gecheline.github.io/astropond/" style={{color: '#d67770'}}>gecheline</a></span></p> 
          </div>
        </div> 
